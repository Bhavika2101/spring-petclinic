...
public class directdebitconsentsConsentIdDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/samples/RoostTest/direct-debit-consents_consentIdDeleteTest.csv", envVarsList);
    }

  
    @Test  
    public void directdebitconsentsConsentIdDelete_Test() throws org.json.JSONException {
        this.setUp();
