...
public class directdebitconsentsConsentIdGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/samples/RoostTest/direct-debit-consents_consentIdGetTest.csv", envVarsList);
    }

  
    @Test  
    public void directdebitconsentsConsentIdGet_Test() throws org.json.JSONException {
        this.setUp();
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://hsbcdeveloperportalpreprod.digitalapicraft.com:8085/https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";  
              ...
              if (response.get("data.consentId") != null) {    
                MatcherAssert.assertThat(response.getString("data.consentId"), matchesPattern("undefined")); 
              ...
              if (response.get("data.creationDate") != null) {    
                MatcherAssert.assertThat(response.getString("data.creationDate"), matchesPattern("undefined")); 
  
                MatcherAssert.assertThat(response.get("data.creationDate"), instanceOf(String.class));  
          }
      
              if (response.get("data.status") != null) {    
                MatcherAssert.assertThat(response.getString("data.status"), matchesPattern("undefined")); 
              ...
              if (response.get("data.statusUpdateDate") != null) {    
                MatcherAssert.assertThat(response.getString("data.statusUpdateDate"), matchesPattern("undefined")); 
              ...
              if (response.get("data.expirationDate") != null) {    
                MatcherAssert.assertThat(response.getString("data.expirationDate"), matchesPattern("undefined")); 
