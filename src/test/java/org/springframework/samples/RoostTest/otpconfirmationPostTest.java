...
public class otpconfirmationPostTest throws org.json.JSONException {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/samples/RoostTest/otpconfirmationPostTest.csv", envVarsList);
    }
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://hsbcdeveloperportalpreprod.digitalapicraft.com:8085/https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";  
              ...
              if (response.get("creditorReference") != null) {    
                MatcherAssert.assertThat(response.getString("creditorReference"), matchesPattern("undefined")); 
