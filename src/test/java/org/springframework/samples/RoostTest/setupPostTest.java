...
public class setupPostTest throws org.json.JSONException {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/samples/RoostTest/setupPostTest.csv", envVarsList);
    }
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://hsbcdeveloperportalpreprod.digitalapicraft.com:8085/https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";  
              ...
              if (response.get("processResult.responseCode") != null) {    
                MatcherAssert.assertThat(response.getString("processResult.responseCode"), matchesPattern("undefined")); 
              ...
              if (response.get("processResult.rejectReasonList["+ i +"].rejectReasonCode") != null) {    
                MatcherAssert.assertThat(response.getString("processResult.rejectReasonList["+ i +"].rejectReasonCode"), matchesPattern("undefined")); 
              ...
              if (response.get("processResult.rejectReasonList["+ i +"].rejectReasonInfomation") != null) {    
                MatcherAssert.assertThat(response.getString("processResult.rejectReasonList["+ i +"].rejectReasonInfomation"), matchesPattern("undefined")); 
              ...
              if (response.get("mandateIdentification") != null) {    
                MatcherAssert.assertThat(response.getString("mandateIdentification"), matchesPattern("undefined")); 
              ...
              if (response.get("otpIdentificationNumber") != null) {    
                MatcherAssert.assertThat(response.getString("otpIdentificationNumber"), matchesPattern("undefined")); 
              ...
              if (response.get("mobileNumber") != null) {    
                MatcherAssert.assertThat(response.getString("mobileNumber"), matchesPattern("undefined")); 
              ...
              if (response.get("mandateStatus") != null) {    
                MatcherAssert.assertThat(response.getString("mandateStatus"), matchesPattern("undefined")); 
